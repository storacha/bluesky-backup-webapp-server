...
NEXT_PUBLIC_STORACHA_SERVICE_DID=did:web:<%= $UPLOAD_PREFIX %>up.storacha.network
NEXT_PUBLIC_STORACHA_PROVIDER=did:web:<%= $UPLOAD_PREFIX %>up.storacha.network
NEXT_PUBLIC_IDENTITY_AUTHORITY=did:web:<%= $UPLOAD_PREFIX %>up.storacha.network
