...
import { SERVER_IDENTITY_PRIVATE_KEY, SERVER_DID, PRODUCTION_UPLOAD_SERVICE_PUBLIC_KEY, STAGING_UPLOAD_SERVICE_PUBLIC_KEY, DID_WEB, DID_KEY, IDENTITY_AUTHORITY } from '../constants';
