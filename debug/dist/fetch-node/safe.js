import { DEFAULT_FORBIDDEN_DOMAIN_NAMES, asRequest, fetchMaxSizeProcessor, forbiddenDomainNameRequestTransform, protocolCheckRequestTransform, redirectCheckRequestTransform, requireHostHeaderTransform, timedFetch, toRequestTransformer, } from '@atproto-labs/fetch';
...
// @ts-expect-error ???
ssrfProtection = true, allowCustomPort = !ssrfProtection, allowData = false, allowHttp = !ssrfProtection, allowIpHost = true, 
// allowPrivateIps = !ssrfProtection,
timeout = 10e3, forbiddenDomainNames = DEFAULT_FORBIDDEN_DOMAIN_NAMES, } = {}) {
    return toRequestTransformer(pipe(
    /**
