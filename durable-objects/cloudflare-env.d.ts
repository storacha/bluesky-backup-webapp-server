// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv --config wrangler.durable-objects.toml durable-objects/cloudflare-env.d.ts` (hash: 2b1321d1d7d43d3baea89b5551e26889)
// Runtime types generated with workerd@1.20250409.0 2024-09-23 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		BLUESKY_AUTH_SESSION_STORE: KVNamespace;
		BLUESKY_AUTH_STATE_STORE: KVNamespace;
		NEXT_PUBLIC_STORACHA_SERVICE_URL: string;
		NEXT_PUBLIC_STORACHA_RECEIPTS_URL: string;
		NEXT_PUBLIC_STORACHA_SERVICE_DID: string;
		NEXT_PUBLIC_STORACHA_PROVIDER: string;
		NEXT_PUBLIC_STORACHA_GATEWAY_HOST: string;
		NEXT_PUBLIC_STORACHA_GATEWAY_ID: string;
		NEXT_PUBLIC_SENTRY_DSN: string;
		NEXT_PUBLIC_SENTRY_ORG: string;
		NEXT_PUBLIC_SENTRY_PROJECT: string;
		NEXT_PUBLIC_SENTRY_ENV: string;
		NEXT_PUBLIC_BLUESKY_CLIENT_URI: string;
		NEXT_PUBLIC_STRIPE_PRICING_TABLE_ID: string;
		NEXT_PUBLIC_STRIPE_PUBLISHABLE_KEY: string;
		BACKUP_DO: DurableObjectNamespace<import("../.durable-objects/durable-objects/index").BackupDO>;
	}
}
