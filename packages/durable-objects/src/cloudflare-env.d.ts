// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv --config wrangler.toml src/cloudflare-env.d.ts` (hash: 2d9db56c5d0412fdf31e4b14cb768227)
...
declare namespace Cloudflare {
	interface Env {
		...
		BACKUP_DO: DurableObjectNamespace /* BackupDO */;
	}
}
